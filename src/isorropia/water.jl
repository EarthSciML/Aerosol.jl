...
function Water(t, active_salts)
    ...
    m_aw_coeffs = Dict(
        :CaNO32_aqs => [36.356, -165.66, 447.46, -673.55, 510.91, -155.56, 0] *
                       unit_molality,
        :CaCl2_aqs => [20.847, -97.599, 273.220, -422.120, 331.160, -105.450, 0] *
                      unit_molality,
        :KHSO4_aqs => [
            1.061,
            -0.101,
    ...
    @variables W(t) = 1.0e-8 [
        unit = u"kg_water/m_air^3",
        description = "Aerosol water content"
    ]
    W = ParentScope(W)
    w = 0
