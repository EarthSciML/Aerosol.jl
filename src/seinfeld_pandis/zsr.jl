...
@component function ZSRWaterContent(; name=:ZSRWaterContent, n_species::Int=3)
    @parameters begin
        ...
        C[1:n_species] = fill(1e-6, n_species), [description = "Salt concentrations", unit = u"mol/m^3"]
        m0[1:n_species] = fill(5.0, n_species), [description = "Binary solution molalities at water activity α_w", unit = u"mol/kg"]
    end
...
# Example
```julia
W = zsr_water_content(0.8, Dict(:NH42SO4 => 1e-6, :NH4NO3 => 2e-6))
```
"""
