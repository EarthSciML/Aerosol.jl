...
@component function NH4NO3Equilibrium(; name=:NH4NO3Equilibrium)
    ...
    @variables begin
        ln_Kp(t), [description = "Log of solid dissociation constant (ppb² basis) (dimensionless)", unit = u"1"]
        DRH_out(t), [description = "Deliquescence RH (dimensionless)", unit = u"1"]
        is_aqueous(t), [description = "Phase indicator (1=aqueous, 0=solid) (dimensionless)", unit = u"1"]
    end
...
"""
function equilibrium_constant_temperature(K_ref::Real, T::Real, T_ref::Real, a::Real, b::Real)
