...
@component function IsorropiaEquilibrium(; name = :IsorropiaEquilibrium)
    ...
    @constants begin
        ...
        K21_0_atm = 5.764e1, [description = "NH3 dissolution equilibrium constant at T0", unit = u"mol/(kg*Constants.atm)"]
        K21_0 = K21_0_atm / p_ref, [description = "NH3 dissolution equilibrium constant at T0 in SI units", unit = u"mol/(kg*Pa)"]
        ...
        K3_0_atm = 1.971e6, [description = "HCl gas-liquid equilibrium constant at T0", unit = u"mol^2/(kg^2*Constants.atm)"]
        K3_0 = K3_0_atm / p_ref, [description = "HCl gas-liquid equilibrium constant at T0 in SI units", unit = u"mol^2/(kg^2*Pa)"]
        ...
        K4_0_atm = 2.511e6, [description = "HNO3 gas-liquid equilibrium constant at T0", unit = u"mol^2/(kg^2*Constants.atm)"]
        K4_0 = K4_0_atm / p_ref, [description = "HNO3 gas-liquid equilibrium constant at T0 in SI units", unit = u"mol^2/(kg^2*Pa)"]
