...
@component function AerosolLayerRadiativeForcing(; name=:AerosolLayerRadiativeForcing)
    ...
    @variables begin
        r_aer(t), [unit = u"1", description = "Fraction of light reflected upward by aerosol"]
        t_aer(t), [unit = u"1", description = "Fraction of light transmitted through aerosol"]
...
@component function CriticalSingleScatteringAlbedo(; name=:CriticalSingleScatteringAlbedo)
    ...
    @variables begin
        ω_crit(t), [unit = u"1", description = "Critical single-scattering albedo (dimensionless)"]
    end
...
@component function CloudAlbedo(; name=:CloudAlbedo)
    ...
    @variables begin
        ...
        γ(t), [unit = u"1", description = "Two-stream approximation coefficient (dimensionless)"]
    end
...
@component function CloudAlbedoSensitivity(; name=:CloudAlbedoSensitivity)
    ...
    @variables begin
        ...
        S(t), [unit = u"1", description = "Twomey susceptibility dR_c/d(ln N) (dimensionless)"]
    end
...
@component function IndirectAerosolForcing(; name=:IndirectAerosolForcing)
    @parameters begin
        ...
        T_a = 0.76, [unit = u"1", description = "Atmospheric transmittance (dimensionless)"]
        R_c = 0.5, [unit = u"1", description = "Cloud albedo (dimensionless)"]
        Δln_N = 0.262, [unit = u"1", description = "Fractional change in CDNC ln(N₁/N₀) (dimensionless)"]
    end
